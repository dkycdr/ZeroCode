...
export const jsBasicsCourse = {
    id: 'js-basics',
    title: 'JavaScript Basics - Complete Programming Fundamentals',
    description: 'Master JavaScript from absolute beginner to intermediate. Learn variables, operators, control flow, functions, arrays, objects, and DOM manipulation with extreme detail and comprehensive examples.',
    icon: '⚡',
