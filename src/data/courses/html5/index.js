...
export const html5Course = {
    id: 'html5',
    title: 'HTML5 - Complete Web Development Foundation',
    description: 'Master HTML5 from absolute beginner to advanced. Learn semantic HTML, forms, multimedia, accessibility, best practices, and build real projects.',
    icon: '🌐',
