...
export const css3Course = {
    id: 'css3',
    title: 'CSS3 - Complete Styling Mastery',
    description: 'Master CSS from absolute beginner to advanced. Learn selectors, Box Model, Flexbox, Grid, responsive design, animations, and build real projects.',
    icon: '🎨',
