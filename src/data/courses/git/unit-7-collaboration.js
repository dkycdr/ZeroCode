...
export const unit7Collaboration = {
  id: 'git-unit-7',
...
Now you understand collaboration! 🤝
    ...
    },
    {
      ...
      duration: '20 min',
      files: [
        { name: 'main.js', content: 'console.log("Production Code");', language: 'javascript' }
      ],
      content: `
...
\`\`\`
      ...
      tasks: [
        {
          id: 'task1',
          description: 'Create branch "feature/login"',
          regex: '"branches":\\[.*"feature/login".*\\]'
        },
        {
          id: 'task2',
          description: 'Create login.js and commit it',
          // Check if last commit message contains "login" or file is in files
          regex: '"files":\\[.*"login.js".*\\]'
        },
        {
          id: 'task3',
          description: 'Push to origin (git push ...)',
          regex: 'git push'
        }
      ]
    },
