...
export const unit6Remote = {
    id: 'git-unit-6',
    title: 'Unit 6: Remote Repositories',
...
\`\`\`
            ...
            tasks: [
                ...
                {
                    id: 'task2',
                    description: 'Add remote "origin" (git remote add ...)',
                    regex: 'git remote add origin' // We check command history for this one
                },
                {
                    id: 'task3',
                    description: 'Push code (git push ...)',
                    regex: 'git push'
                }
            ]
        },
...
\`\`\`
        ...
        },
        {
            ...
            questions: [
                {
                    id: 'q1',
                    question: 'What command downloads an entire repository?',
                    options: ['git down', 'git pull', 'git clone', 'git checkout'],
                    correctIndex: 2,
                    explanation: '`git clone` is used to download an entire existing repository from a URL.'
                },
                {
                    id: 'q2',
                    ...
                    correctIndex: 1,
                    explanation: '`origin` is just the standard default name given to the primary remote server. You can rename it, but it\'s standard convention.'
                },
                {
                    id: 'q3',
                    question: 'Which command uploads your changes?',
