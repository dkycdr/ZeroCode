...
export const unit7RebaseCherrypick = {
    id: 'git-unit-7',
    title: 'Unit 7: Advanced History (Rebase & Cherry-pick)',
...
\`\`\`
            ...
            tasks: [
                {
                    id: 'task1',
                    text: 'Cherry-pick a commit (use any hash)',
        ...
        },
        {
            ...
            questions: [
                {
                    id: 'q1',
                    text: 'Which command rewrites history?',
