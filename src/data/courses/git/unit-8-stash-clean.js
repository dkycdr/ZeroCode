...
export const unit8StashClean = {
    id: 'git-unit-8',
    title: 'Unit 8: Stashing & Cleaning',
...
\`\`\`
            ...
            tasks: [
                {
                    id: 'task1',
                    text: 'Run dry run (git clean -n)',
                    regex: 'git clean -n'
                },
                {
                    id: 'task2',
                    text: 'Force clean (git clean -f)',
                    regex: 'git clean -f'
                }
            ]
        },
        {
            ...
            questions: [
                ...
                {
                    id: 'q2',
                    text: 'Which command applies the stash and removes it from the list?',
                    options: ['git stash apply', 'git stash pop', 'git stash drop', 'git stash pick'],
                    correct: 1
                },
                {
                    id: 'q3',
                    text: 'Why should you run git clean -n first?',
